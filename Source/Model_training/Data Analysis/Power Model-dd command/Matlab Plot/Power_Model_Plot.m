...
x=600:2200;
y1=0.000685*x-0.04466;
y2=0.000827*x-0.0529;
...
legend('Raw Data (dd)','Fitting Model (dd Command)','Fitting Model (Matrix Multiplication)','Location','NorthWest')
set(gca,'FontSize',12);
...
x=200:900;
y1=0.000211*x-0.000708;
y2=0.0001722*x+0.00006534;
plot(x,y1,'Color',[1,0,0])
plot(x,y2,'Color',[1,0.5,0])
ylim([0.03,0.16])
xlabel('Voltage^2¡ÁFrequency')
