...
# Read the data file
Data<-read.csv("Execution Time dd.csv")

# Frequency = 1600MHz
# Data Pre-processing
Features_1600=subset(Data,Frequency==1600,select=c("dd"))
...
# Frequency = 1500MHz
# Data Pre-processing
Features_1500=subset(Data,Frequency==1500,select=c("dd"))
...
# Frequency = 1400MHz
# Data Pre-processing
Features_1400=subset(Data,Frequency==1400,select=c("dd"))
...
# Frequency = 1300MHz
# Data Pre-processing
Features_1300=subset(Data,Frequency==1300,select=c("dd"))
...
# Frequency = 1200MHz
# Data Pre-processing
Features_1200=subset(Data,Frequency==1200,select=c("dd"))
...
# Frequency = 1100MHz
# Data Pre-processing
Features_1100=subset(Data,Frequency==1100,select=c("dd"))
...
# Frequency = 1000MHz
# Data Pre-processing
Features_1000=subset(Data,Frequency==1000,select=c("dd"))
...
# Frequency = 900MHz
# Data Pre-processing
Features_900=subset(Data,Frequency==900,select=c("dd"))
...
# Frequency = 800MHz
# Data Pre-processing
Features_800=subset(Data,Frequency==800,select=c("dd"))
...
# Frequency = 600MHz
# Data Pre-processing
Features_600=subset(Data,Frequency==600,select=c("dd"))
...
# Frequency = 550MHz
# Data Pre-processing
Features_550=subset(Data,Frequency==550,select=c("dd"))
...
# Frequency = 500MHz
# Data Pre-processing
Features_500=subset(Data,Frequency==500,select=c("dd"))
...
# Frequency = 450MHz
# Data Pre-processing
Features_450=subset(Data,Frequency==450,select=c("dd"))
...
# Frequency = 400MHz
# Data Pre-processing
Features_400=subset(Data,Frequency==400,select=c("dd"))
...
# Frequency = 350MHz
# Data Pre-processing
Features_350=subset(Data,Frequency==350,select=c("dd"))
...
# Frequency = 300MHz
# Data Pre-processing
Features_300=subset(Data,Frequency==300,select=c("dd"))
...
# Frequency = 250MHz
# Data Pre-processing
Features_250=subset(Data,Frequency==250,select=c("dd"))
...
# Frequency = 200MHz
# Data Pre-processing
Features_200=subset(Data,Frequency==200,select=c("dd"))
...
# Frequency = 150MHz
# Data Pre-processing
Features_150=subset(Data,Frequency==150,select=c("dd"))
...
# Frequency = 100MHz
# Data Pre-processing
Features_100=subset(Data,Frequency==100,select=c("dd"))
